...
\section*{\protect \fg{漢字}{かんじ}や\fg{単語}{たんご}}

\fg{正月}{しょうがつ}（new year's day）
...
% remember to terminate a command with {} if you want a trailing space...
%\subsection*{the \TUG{}  and an introduction to Lua\TeX }


\section*{\protect \fg{文法}{ぶんぽう}}
